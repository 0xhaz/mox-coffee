...
@notice A contract for people to send ETH to support your work
"""

from src.interfaces import AggregatorV3Interface
from src import get_price_module 
...
def _fund():
    ...
    Have a minimum $ amonut to send

    How do we convert the ETH amount to dollars?
    """
